        ...
        >
          ...
          <div className="flex items-center justify-center w-full h-full">
            <button
              ...
              onClick={(e) => { e.stopPropagation(); setImgToShow(imgToShow === 0 ? images.length - 1 : imgToShow - 1); }}
              aria-label="Previous image"
            >
              &#8592;
            </button>
            <img
              src={images[imgToShow]?.url}
            ...
            <button
              ...
              onClick={(e) => { e.stopPropagation(); setImgToShow(imgToShow === images.length - 1 ? 0 : imgToShow + 1); }}
